          ...
          <section className="mt-10 md:mt-0">
            ...
            <div>
              ...
              <div className="flex gap-3 md:flex-row md:gap-4 flex-wrap">
                <Link
                  target="_blank"
                  aria-label="Picc-a-Dilly facebook page"
                ...
                <Link
                  target="_blank"
                  aria-label="Picc-a-Dilly instagram profile"
                ...
                <Link
                  target="_blank"
                  aria-label="Picc-a-Dilly youtube channel"
                ...
                <Link
                  target="_blank"
                  aria-label="Picc-a-Dilly twitter account"
        ...
        <div className="w-full max-w-[2560px] mx-auto flex md:flex-col md:gap-8">
          ...
          <div className="lg:pr-4 md:pr-0">
            <div className="flex flex-wrap items-center gap-4 mb-4 md:mb-8">
              ...
              >
                Picc-a-Dilly<span className="text-green-1">Go</span>
              </Link>
              <Image
