...
const imagesAlts = [
	...
	"Picc-a-Dilly blog, discover healthy recipes and food tips for the whole family on our blog",
	"space you spa and sauna, located on every Picc-a-Dilly store",
	"back to school, find everything you need to ace your classes",
	"valentine's day, find that perfect gift for your love",
	"gourmet restaurant and bar, located on every Picc-a-Dilly store",
	"Picc-a-Dilly christmas, we have everything to make your holiday season merry and bright"
]
