                  ...
                  {secondIsOpen && (
                    ...
                    >
                      <p className="text-neutral-500 text-left leading-6">
                        Visit the Picc-a-Dilly website or app and select the
                  ...
                  {thirdIsOpen && (
                    ...
                    >
                      <p className="text-neutral-500 text-left leading-6">
                        ...
                        Picc-a-Dilly operates, including inland areas, coastal
              ...
              <div className="w-4/5 md:w-full flex flex-col items-center px-10 py-7 md:px-6 md:py-4">
                ...
                <AnimatePresence>
                  {fourthIsOpen && (
                    ...
                    >
											<p className="text-neutral-500 text-left leading-6">
Make your purchase on the Picc-a-Dilly website or app, select
