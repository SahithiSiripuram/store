    ...
    <div className="px-20 md:px-10 w-full bg-green-4 text-neutral-50 pb-[9.5rem]">
      <div className="mx-auto max-w-[2560px]">
        <div className="flex justify-around lg:flex-wrap md:whitespace-normal">
          <Link
            href="https://Picc-a-Dilly.vercel.app/credit-card"
        ...
        <div className="whitespace-normal text-sm space-y-4">
          <div>
            <p>
              To access all the benefits of Picc-a-Dilly stores and the Picc-a-Dilly
              ...
              Loyalty Club, managed by Picc-a-Dilly. If you prefer, you can already
              enjoy the Customer Plus benefits by downloading the Picc-a-Dilly app
          ...
          <div>
            <p>
              ...
              Picc-a-Dilly and Customer Plus bring work, as failure to comply with
          ...
          <div>
            <p>
              ...
              provide your credit analysis. Picc-a-Dilly simply provides quicker and
