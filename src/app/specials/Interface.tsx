...
const specials = [
  ...
  },
  {
    ...
    image: ChefIcon,
    description:
      "Elevate Your Culinary Experience: Enlist the Expertise of Our Renowned Chef. At Picc-a-Dilly, we are dedicated to crafting unforgettable dining experiences. Our highly skilled chef brings a wealth of expertise to your table, curating exquisite menus tailored to your preferences and event. We pride ourselves on delivering culinary excellence and exceptional service that leaves a lasting impression on your guests.",
  },
  {
